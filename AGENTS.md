...
Omnixys shared media/storage package (S3/MinIO with aiobotocore).

- Repository path: `packages/python/media` (relative to the Omnixys root)
...
src/media/ S3/MinIO storage adapters
